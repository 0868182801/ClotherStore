...
if(isset( $_GET['danhmuc_id'])){
    ...
    $sanpham = mysqli_query($conn , "SELECT * FROM `sanpham` WHERE `danhmuc_id` = '$danhmuc_id'");
}

if(isset( $_GET['sale_id'])){
    $sale_id = $_GET['sale_id'];
    $sanpham = mysqli_query($conn , "SELECT * FROM `sanpham` WHERE `sale_id` = '$sale_id'");
}
?>
            <div style="padding-top: 65px;" class="container-fluid">
                <section class="home-new-prod">
                    <div class="title-section">ĐỀ XUẤT CHO BẠN</div>
